    ...
    <section id="features" className="mx-auto mt-24 max-w-6xl px-6">
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {tiles.map((tile) => (
          <article
            key={tile.label}
            className="group relative overflow-hidden rounded-[28px] border border-white/10 bg-white/5 p-6 shadow-[0_25px_45px_rgba(4,11,24,0.35)] transition hover:-translate-y-1 hover:border-brand-400/40 hover:shadow-[0_32px_60px_rgba(29,160,230,0.25)] backdrop-blur"
          >
            ...
            <div className="relative space-y-4">
              <span className="inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-500/15 text-2xl">
                {tile.icon}
              </span>
